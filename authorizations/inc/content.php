<section id="content">
	...
	<div class="container">
		...
		<div class="col-md-3 text-center"><a href="Leaverequest.php">
		<span class="icons c2"><i class="fa fa-picture-o"></i></span> <div class="box-area">
		<h3>Leave Request</h3> <p>Leave Request Here</p></div></a>
		</div>
		<div class="col-md-3 text-center"><a href="requisition/index.php?user=<?php echo $userId;?>">
		<span class="icons c1"><i class="fa fa-trophy"></i></span> <div class="box-area">
		<h3>Fund Requisition</h3> <p>Requisition</p></div></a>
		</div>
