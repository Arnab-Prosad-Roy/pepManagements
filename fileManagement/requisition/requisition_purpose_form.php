...
<div class="row">
	<div class="col-md-8">
		<h2 style="text-decoration: underline; font-weight: normal;">Fund Requisition Form</h2>
	</div>
	<div class="col-md-4">
...
?>
	...
	?>
		<form action="" method="post">
			<div class="col-md-6">
				<label style="margin-bottom: 26px;font-size: 18px;font-weight: normal;">Purpose & Full Description</label>
