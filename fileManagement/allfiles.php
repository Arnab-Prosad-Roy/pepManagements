...
<div class="row" style="margin-left: 14px; margin-right:14px;">
	<div class="col-md-12">
		<?php 
      $getfile = $file->getFileNameByuserId($userId);
      if ($getfile) {
        ...
        <?php 
          ...
          $num = $static+$id;
           ?>
  <div class="panel-body" style="border-bottom: 1px dashed;">
    
  <div id="adminForm">
<p><?php echo $fm->formDate($rowdata['createDate']);?></p>
    <h4 style="text-align: center; font-weight: normal;">File ID: -<?php echo $num;?>&nbsp;&nbsp; ||Department Id :- <?php echo $rowdata['deptName'];?></h4>    
    <p style="text-align: center;font-size: 36px; margin-bottom:24px;"><?php echo $rowdata['filename']; ?></p>
